...
\begin{itemize}
    ...
    \item \textbf{complete} allows a user to preserve the values that may already be present for the collection property, and add more values.
    ...
    \item \textbf{suggest} allows user to suggest a value to guide search, and guide repair using ATL$^{\text{c}}$ suggestion system.
    ...
    % \item \textbf{complete} allows a user to preserve the values that may already be present for the properties.
    \item \textbf{stay} guides model repair, uses ATL$^{\text{c}}$ weights for weighted CSP.
