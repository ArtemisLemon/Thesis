...
\begin{figure}[!ht]
    ...
    % \label{fig:metamodel}
\end{figure}
In this figure the arrows towards the matrix are the \textit{and} between the input and output, and the arrow towards the output is the \textit{or} on the column.
