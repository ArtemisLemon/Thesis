...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Section \ref{sec:ctxt} presents the context of our work.
Section \ref{sec:contrib_encoding} describes the CP model for representing UML instances and evaluating queries. 
Section \ref{sec:contrib_enforcing_type} details the CP models used to enforce collection types and break symmetries within instances. 
%we present the CP models to enforce collection type and break symmetries on the instance.
In Section \ref{sec:contrib_type_casting}, we present CP models for casting between different collection types. 
Section \ref{sec:tests} reports some experimental results, and Section \ref{sec:conclusion} provides a discussion and concluding remarks.
%In Section \ref{sec:conclusion} we will further discuss these models and conclude. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Context: UML \& CP}\label{sec:ctxt}
...
\section{CP Models for UML Instances and OCL Queries}\label{sec:contrib_encoding}
...
%\subsection{Encoding properties}\label{ssec:contrib_encoding_properties}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{CP Models for OCL Collection Type Casting Operations}\label{sec:contrib_type_casting}
...
\section{Experimental Results}\label{sec:tests}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[trim={0 20 0 0},width=1\linewidth]{Articles/ICTAI2025/figures/zooMM.pdf}
...
% \begin{figure}[!ht]
%     \centering
%     \includegraphics[trim={0 20 0 0},width=1\linewidth]{figures/rmsMM.pdf}
