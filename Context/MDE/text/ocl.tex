...
\begin{lstlisting}
  context Task inv: 
    Task.allInstances().includes(self)
\end{lstlisting}
We can also access all the object of a class from within a context of any class.
...
OCL operations generally are applied to OCL expressions, which we call source, which can be understood as the first argument for the operation.
