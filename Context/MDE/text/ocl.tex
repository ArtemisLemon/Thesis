...
We will consider these rules as an optional part of a metamodel, and not distinguish between \textit{metamodel} and textit{constrained metamodel}.
...
This implies this expression will have a different interpretation for each individual object.
...
\subsubsection{Navigation: accessing data from the model}
...
\begin{figure}[!ht]
  ...
  % \label{fig:model}
\end{figure}
This cheat sheet outlines all the available OCL expressions, organized by the types they can be applied to.
