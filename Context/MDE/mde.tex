...
In the following sections we'll present the modeling languages UML and OCL.
...
\input{Context/MDE/text/emf}
\input{Context/MDE/text/atl}

\section{Examples of Metamodels used in this Thesis}
\input{Context/MDE/text/exampleModels/generic}
\input{Context/MDE/text/exampleModels/gui}
\input{Context/MDE/text/exampleModels/rms}
\input{Context/MDE/text/exampleModels/zoo}
\input{Context/MDE/text/exampleModels/schedule}